...
function fill(index_column, visible, reception_dt, duration, color, card_no, person_name, reception_name, comment, arrival_status, payment_status, visit_confirmation, tags, receptions, durations) {
    ...
    if(visible===false) {
        createEmptyReceptionSlot(`schedule-container-${foundedDurationIndex + 1}`, index_column, durations[foundedDurationIndex].startTime, reception_dt, duration, color, card_no, person_name, reception_name, comment, arrival_status, payment_status, visit_confirmation, tags, filtred_receptions);
    }
    else {
        createReceptionSlot(`schedule-container-${foundedDurationIndex + 1}`, index_column, durations[foundedDurationIndex].startTime, reception_dt, duration, color, card_no, person_name, reception_name, comment, arrival_status, payment_status, visit_confirmation, tags, filtred_receptions);
    }
}
